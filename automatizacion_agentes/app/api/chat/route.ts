...
const SYSTEM_PROMPT = [
  ...
  "[Basandote en el sector, necesidad y si quiere web o no, recomienda el plan adecuado:",
  "- Si NO quiere web: elige entre Auto Starter 49EUR/mes (negocios pequenos, poco volumen), Auto Pro 89EUR/mes (volumen medio, varias automatizaciones) o Auto Elite 149EUR/mes (alto volumen, multicanal). Explica en 2-3 frases por que ese plan.",
  "- Si SI quiere web: recomienda Pro con web desde 799EUR+49EUR/mes y explica en 2-3 frases el valor anadido.",
  "- NUNCA menciones la opcion de web si el cliente ha dicho que no la quiere.]",,
  "---",
  "",
